...
OptionButton::OptionButton(const sf::Vector2f& pos,
...
void OptionButton::addOption(const std::string& option) { _options.push_back(option); }
...
const std::string& OptionButton::getSelection() const { return _options[_currentOption]; }
