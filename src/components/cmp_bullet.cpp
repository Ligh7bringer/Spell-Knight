...
bool BulletComponent::isExploded() const { return _exploded; }

//sets the damage done by the bullet
void BulletComponent::setDamage(int dmg) { _damage = dmg; }

//returns the damage done by the bullet
int BulletComponent::getDamage() const { return _damage; }
