...
ParticleSystemComponent::ParticleSystemComponent(Entity* p,
...
//render particles
void ParticleSystemComponent::render() { Engine::GetWindow().draw(_particles); }

//setter for colour of particles
void ParticleSystemComponent::setColour(sf::Color c) { _particles.setColour(c); }

void ParticleSystemComponent::setRepeat(bool r) { _repeat = r; }

void ParticleSystemComponent::setEmissionRate(float rate) { _particles.setEmissionRate(rate); }
...
void ParticleSystemComponent::setLifetime(float lt) { _particles.setLifetime(lt); }
