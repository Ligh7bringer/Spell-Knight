...
ParallaxBackground::ParallaxBackground(const sf::Vector2f& size)
	: _target(Vector2f(0.f, 0.f))
{
...
void ParallaxBackground::setWidthMultiplier(int mult) { _widthMultiplier = mult; }