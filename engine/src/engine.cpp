...
sf::View& Engine::getCurrentView() { return _activeScene->getView(); }

void Engine::setView(const sf::View& view) { _activeScene->setView(view); }
Event event;
...
std::vector<char>& Engine::getKeysText() { return _keysText; }
...
void Engine::toggleFullscreen()
{
	...
	if(_fullscreen)
	{
		_window->create(VideoMode(_currentResolution.x, _currentResolution.y),
						_gameName,
						sf::Style::Fullscreen);
	}
	else
...
bool Engine::isFullscreen() { return _fullscreen; }
...
void Engine::setResolution(const sf::Vector2u& res)
{
	...
	_window->create(VideoMode(res.x, res.y),
					_gameName,
					_fullscreen ? sf::Style::Fullscreen : sf::Style::Close | sf::Style::Resize);
}

std::vector<sf::Keyboard::Key>& Engine::getKeys() { return _keys; }

bool Engine::isPaused() { return _pause; }

const Vector2u& Engine::getResolution() { return _currentResolution; }
...
sf::View& Scene::getView() { return _view; }

void Scene::setView(const sf::View& view) { _view = view; }
