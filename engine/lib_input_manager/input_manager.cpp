...
void InputManager::initialise()
{
	addKey("jump",
		   Event::KeyPressed,
		   static_cast<sf::Keyboard::Key>(stoi(Config::getSetting("jump"))));
	addKey("shoot",
		   Event::KeyPressed,
		   static_cast<sf::Keyboard::Key>(stoi(Config::getSetting("shoot"))));
	addKey("walkLeft",
		   Event::KeyPressed,
		   static_cast<sf::Keyboard::Key>(stoi(Config::getSetting("walkLeft"))));
	addKey("walkRight",
		   Event::KeyPressed,
		   static_cast<sf::Keyboard::Key>(stoi(Config::getSetting("walkRight"))));
...
void InputManager::addKey(const string& action,
						  ...
						  sf::Keyboard::Key key)
{
	...
	for(auto& _binding : _bindings)
	{
		...
		{
			LOG(INFO) << "Overwriting existing key binding for action " + action << " with key "
					  << key << "!";
...
sf::Keyboard::Key InputManager::getKey(const string& action) { return _bindings[action]._keyCode; }
